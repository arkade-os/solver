...
SELECT pair, min_base_amount, max_base_amount, base_decimals, quote_decimals, price_feed, invert_price, tolerance_bps, fee_bps, base_name, base_ticker, quote_name, quote_ticker, price_decimals FROM banco_pair
`
